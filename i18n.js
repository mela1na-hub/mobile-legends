(function () {
  ...
  const dict = {
    en: {
      ...
      feat_battle_t: "5v5 Battle",
      feat_battle_p: "Classic MOBA experience",
      feat_team_t: "Team Play",
      feat_team_p: "5 roles, one victory",
      feat_heroes_t: "120+ Heroes",
      feat_heroes_p: "Unique kits and skins",
      feat_rank_t: "Ranked",
      feat_rank_p: "Climb to Mythic",
      explore_heroes: "Explore Heroes",
      ...
      shop_lead:
        "Browse by category in order: Attack, Attack & Magic, Defense, Jungling, Magic, Movement, Roam.",
      ...
      cat_all: "All",
      cat_attack: "Attack",
      cat_attack_magic: "Attack & Magic",
      cat_defense: "Defense",
      cat_jungling: "Jungling",
      cat_magic: "Magic",
    ...
    uz: {
      ...
      feat_battle_t: "5v5 Jang",
      feat_battle_p: "Klassik MOBA tajribasi",
      feat_team_t: "Jamoa",
      feat_team_p: "5 rol, bitta g‘alaba",
      feat_heroes_t: "120+ qahramon",
      feat_heroes_p: "O‘ziga xos skill va skinlar",
      feat_rank_t: "Ranked",
      feat_rank_p: "Mythicgacha ko‘taring",
      explore_heroes: "Qahramonlar",
      view_all_heroes: "Barchasi ›",
      ...
      shop_lead:
        "Kategoriyalar ketma-ketligi: Hujum, Hujum va sehr, Himoya, Jungle, Sehr, Harakat, Roam.",
      ...
      cat_all: "Hammasi",
      cat_attack: "Hujum",
      cat_attack_magic: "Hujum va sehr",
      cat_defense: "Himoya",
      cat_jungling: "Jungle",
      cat_magic: "Sehr",
      cat_movement: "Harakat",
      cat_roam: "Roam",
      cat_boots: "Harakat",
      cat_jungle: "Jungle",
    ...
    ru: {
      ...
      feat_battle_t: "Бой 5v5",
      feat_battle_p: "Классическая MOBA",
      feat_team_t: "Команда",
      feat_team_p: "5 ролей, одна победа",
      feat_heroes_t: "120+ героев",
      feat_heroes_p: "Уникальные скиллы и скины",
      feat_rank_t: "Рейтинг",
      feat_rank_p: "Путь к Mythic",
      explore_heroes: "Герои",
      view_all_heroes: "Все герои ›",
      ...
      shop_lead:
        "Категории по порядку: Атака, Атака и магия, Защита, Лес, Магия, Передвижение, Роум.",
      ...
      cat_all: "Все",
      cat_attack: "Атака",
      cat_attack_magic: "Атака и магия",
      cat_defense: "Защита",
      cat_jungling: "Лес",
      cat_magic: "Магия",
      cat_movement: "Передвижение",
      cat_roam: "Роум",
      cat_boots: "Передвижение",
      cat_jungle: "Лес",
